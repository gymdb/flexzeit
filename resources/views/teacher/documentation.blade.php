    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <section class="panel panel-default">
          <h2 class="panel-heading">@lang('messages.documentation.link')</h2>
          <documentation inline-template>
            <div class="panel-body">
              ...
              <div v-else-if="!registrations.length" class="alert alert-warning">@lang('registrations.noMatching')</div>
              <div v-else class="table-responsive">
                <table class="table table-squeezed">
                  ...
                  <tr>
                    ...
                    <th>@lang('messages.documentation.header')</th>
                  </tr>
                  </thead>
                  <tr v-for="reg in registrations">
                    <td>@{{reg.lesson.date}}</td>
                    <td>@{{reg.teacher}}</td>
                    <td class="wrap">@{{reg.documentation || '@lang('registrations.noDocumentation')'}}</td>
                  </tr>
                </table>
              </div>
